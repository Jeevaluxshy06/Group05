...
<div class="mb-3 row">
  ...
  <div class="col-auto">
  <center>  <button type="submit" text-align="center" class="btn btn-primary mb-3" herf="<?php echo e(url('login')); ?>">Login</button></center>
  </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ctms\Downloads\assignments\HelloApp\resources\views/customer/index.blade.php ENDPATH**/ ?>
    ...
    <?php endif; ?>
        ...
        <div class="container">
            <div class="button1">
                ...
                <button class="b2" ><a href="/loginm"> Medical Rep</a></button>
            ...
            <div class="input">
                <form method= "post" action="<?php echo e(route('login')); ?>" >
                    <?php echo csrf_field(); ?>
                <input type="text" placeholder="Work ID" name="slmc"/>
            </div>
                    <br>
                     ...
                     <div class="doc-login-button">
                             <button class="b3"><b><a href="/mprofile">Log in</a></b></button>
                      </div>
                      <br>
                      <p class="link">
                        <a > Don't have an account? </a> <a href="<?php echo e(route('reg')); ?>">  Sign Up</a>
                     </p>
...
<?php /**PATH C:\Users\Anjana\HelloApp\resources\views/loginm.blade.php ENDPATH**/ ?>